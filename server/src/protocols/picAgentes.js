...
const SPECS = {
  ...
  carbono: {
    especialidade: 'Créditos de carbono: quantificação GHG Protocol, elegibilidade Verra/Gold Standard, MRV digital, aposentadoria em registro público e o ativo BIOGEN (1 token = 1 tCO₂e verificado e aposentado). Domina o sequestro adicional por ganho de área foliar com Coin Max, sempre em modo ESTIMATIVA até haver MRV instrumentado.',
    cooperacao: ['tucuju', 'esg', 'curupira', 'gaia'],
    gatilhos: ['usuário calculou passivo e não compensou em 7 dias', 'biostartup sem cálculo de passivo ambiental', 'projeto com área cultivada sem simulação de sequestro Coin Max'],
  },
  energia: {
  ...
  // A chave continua 'biogenesis' porque é o id do agente já gravado em
  // conversas e projetos existentes. O nome de exibição virou Coin Max AI.
  biogenesis: {
    especialidade: 'Coin Max: protocolo de aplicação (5 L/ha, 2 aplicações, 60 dias de intervalo), leitura de laudos, curadoria do Selo de Evidência e separação rigorosa entre resultado documentado e mecanismo em investigação.',
