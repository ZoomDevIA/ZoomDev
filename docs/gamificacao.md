...
## 1. Princípio central: o Game Loop é a jornada da startup

A jornada que já existe no protótipo (Ideação → Validação → MVP → Tração → Escala) vira a
progressão do jogo. Cada estágio é um "mundo" com missões, e avançar de estágio é o momento
épico da experiência (celebração visual, badge, recompensa em créditos).

Metáfora bio-amazônica para os níveis da startup (coerente com o branding floresta digital):

| Nível | Nome | Critério real |
|---|---|---|
| 1 | 🌱 Semente | ideia descrita e estruturada pela IA |
| 2 | 🌿 Broto | hipóteses validadas (entrevistas/landing com conversão) |
| 3 | 🌳 Árvore | MVP no ar com deploy + primeiros usuários |
| 4 | 🌲 Copa | tração (usuários ativos/receita/edital submetido) |
| 5 | 🌴 Floresta | escala (receita recorrente, investimento, edital aprovado) |

## 2. Mecânicas

### XP e níveis do fundador (separados do nível da startup)
...
- **Editais como "boss battles"**: cada edital aberto vira um desafio com prazo, checklist de
  ...
  (créditos + badge exclusivo + destaque na comunidade).
...
### Arena de lançamentos (Launch Arena)
- Galeria interna estilo Product Hunt: MVPs lançados na semana recebem upvotes da comunidade;
  top da semana ganha créditos e destaque. (Lovable provou o modelo fora do produto; a ZoomDev
  o integra nativamente.)

### Ranking e temporadas
- Leaderboard por temporada (mensal/trimestral) com ligas (Bronze→Diamante) por XP de progresso.
- Temporadas temáticas ligadas a editais e datas do ecossistema (ex.: "Temporada COP",
  "Temporada Centelha") com recompensas cosméticas e créditos.

### Agentes como companions evoluíveis
- Os 5 agentes (Produto, Negócio, Engenharia, Impacto, Editais) e os agentes amazônicos
  (ForestEye, EditalBot, BioBazaar...) têm avatar, personalidade e "afinidade" que cresce com o
  uso, desbloqueando capacidades (análises mais profundas, templates exclusivos).
- Conecta-se à **Econ. Agentes** já prevista no protótipo: alugar/publicar agentes na
  comunidade vira endgame de criadores avançados.
